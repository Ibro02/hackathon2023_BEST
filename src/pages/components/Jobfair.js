...
function Jobfair() {
  ...
  return (
    ...
    <Box  px={{base: "0", md:80}} textAlign={"justify"}>
...
<Flex flexDir={"column"}  m={{base: 5, md: 0
}}>

<Flex flexDir={"column-reverse"} justifyContent={"space-evenly"} p={{md:"10", base:"0"}} alignItems={"space-between"} fontWeight={100}>


<Text fontSize={{base: "2xl", md:"3xl"}} flexDir={{base: "column", md:"column", lg:"row"}} fontWeight={200} justifyContent={{base:"space-between", lg:"space-between"}} alignItems={{base: "space-between", md: "normal"}} backgroundColor={"#292929"} color={"whiteAlpha.900"} mx={{base: "1.5", md:"10"}}   borderRadius={"10"} boxShadow={" 1px 1px 2px black"} p={"10"}>
...
<Image  boxSizing={"80"} width={"auto"} m={"auto"}  h={"60"} src={"/job.png"} mt={"50"}></Image>
</Flex>
            </Box>
    </Box>
  )
