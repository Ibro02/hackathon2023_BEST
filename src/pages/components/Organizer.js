...
<Image src="/BEST_signature_mostar_white.png" alt={"bestImg"}boxSize={40} boxSizing={"border-box"} width={"auto"}></Image>
    </Box>
...
<Image src="/Bestovci.jpg"alt={"bestImg"} display={{base:"none", md:"flex"}} shadow={"4px 4px 10px black"}  borderRadius={{base: '10px 0 0 10px', lg: "0 10px 10px 0"}} boxSize={"border-box"} bgSize={'cover'} ml={{base: "0", md: "0"}} my={"auto"} h={{base: "100%", md:"100%"}} width={{base: "100%", md:"100%", lg:"100%"}}></Image>

<Image src="/BestovciMd.jpg"alt={"bestImg"} display={{base:"flex", md:"none"}} shadow={"4px 4px 10px black"} boxSizing={"border-box"} borderRadius={{base: '10px 0 0 10px', lg: "0 10px 10px 0"}} boxSize={"border-box"} bgSize={'cover'} ml={{base: "0", md: "0"}} my={"auto"} h={{base: "100%", md:"100%"}} width={{base: "100%", md:"100%", lg:"0"}}></Image>
